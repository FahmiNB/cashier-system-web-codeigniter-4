 ...
 foreach ($dataYear as $key => $value) { 
    ...
    ?>
            ...
            <tr>
                ...
                <td class="text-right">Rp <?= $dataYear == null ? '' : number_format(array_sum($grandTotal), 0) ?></td>
                <td class="text-right">Rp <?= $dataYear == null ? '' : number_format(array_sum($grandProfit), 0) ?></td>
            </tr>
        </table>
    </div>